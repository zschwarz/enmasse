...
class QueueTest extends TestBase implements ITestSharedBrokered {
    ...
    void testLargeMessages(JmsProvider jmsProvider) throws Exception {
        ...
        MessagingUtils.sendReceiveLargeMessage(jmsProvider, 90, addressQueue, 1);
        MessagingUtils.sendReceiveLargeMessage(jmsProvider, 50, addressQueue, 1);
        MessagingUtils.sendReceiveLargeMessage(jmsProvider, 10, addressQueue, 1);
        MessagingUtils.sendReceiveLargeMessage(jmsProvider, 1, addressQueue, 1);
        MessagingUtils.sendReceiveLargeMessage(jmsProvider, 90, addressQueue, 1, DeliveryMode.PERSISTENT);
        MessagingUtils.sendReceiveLargeMessage(jmsProvider, 50, addressQueue, 1, DeliveryMode.PERSISTENT);
        MessagingUtils.sendReceiveLargeMessage(jmsProvider, 10, addressQueue, 1, DeliveryMode.PERSISTENT);
        MessagingUtils.sendReceiveLargeMessage(jmsProvider, 1, addressQueue, 1, DeliveryMode.PERSISTENT);
    }
}
